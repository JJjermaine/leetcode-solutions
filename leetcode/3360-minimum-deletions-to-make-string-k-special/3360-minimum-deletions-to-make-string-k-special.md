<h1>3360 - Minimum Deletions to Make String K-Special</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-deletions-to-make-string-k-special/">minimum-deletions-to-make-string-k-special</a></h2><p>You are given a string <code>word</code> and an integer <code>k</code>.</p>
