<h1>1049 - Minimum Domino Rotations For Equal Row</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-domino-rotations-for-equal-row/">minimum-domino-rotations-for-equal-row</a></h2><p>In a row of dominoes, <code>tops[i]</code> and <code>bottoms[i]</code> represent the top and bottom halves of the <code>i<sup>th</sup></code> domino. (A domino is a tile with two numbers from 1 to 6 - one on each half of the tile.)</p>
