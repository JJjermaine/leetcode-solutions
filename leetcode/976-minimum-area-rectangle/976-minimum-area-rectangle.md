<h1>976 - Minimum Area Rectangle</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-area-rectangle/">minimum-area-rectangle</a></h2><p>You are given an array of points in the <strong>X-Y</strong> plane <code>points</code> where <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code>.</p>
