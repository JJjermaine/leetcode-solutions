<h1>2221 - Check if a Parentheses String Can Be Valid</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/check-if-a-parentheses-string-can-be-valid/">check-if-a-parentheses-string-can-be-valid</a></h2><p>A parentheses string is a <strong>non-empty</strong> string consisting only of <code>&#39;(&#39;</code> and <code>&#39;)&#39;</code>. It is valid if <strong>any</strong> of the following conditions is <strong>true</strong>:</p>
